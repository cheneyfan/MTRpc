...
enum ErrorCode {
    ...
    CLIENT_CONNECT_IPROCESS  = 1002,

    CLIENT_CANCEL_BY_ERROR   = 1003,
    CLIENT_CANCEL_BY_CLOSE   = 1004,
    CLIENT_SEQ_NOT_MATCH     = 1005,

    CLIENT_RECV_TIMEOUT      = 1006,
    CLIENT_SEND_TIMEOUT      = 1007,
