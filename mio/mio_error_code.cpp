...
const char* ErrorString(int error_code)
{
    switch(error_code)
    {
        ...
        "Not Found";//MAKE_CASE(HTTP_SERVER_NOTFOUND);
        "Not Found";//MAKE_CASE(HTTP_METHOD_NOTFOUND);
        MAKE_CASE(HTTP_REQUEST_OVERFLOW);
        ...
        MAKE_CASE(CLIENT_CANCEL_BY_CLOSE);
        MAKE_CASE(CLIENT_CANCEL_BY_ERROR);
        MAKE_CASE(CLIENT_SEQ_NOT_MATCH);
        MAKE_CASE(CLIENT_RECV_TIMEOUT);
        MAKE_CASE(CLIENT_SEND_TIMEOUT);
    }
